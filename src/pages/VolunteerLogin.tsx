            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div className="form-group">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                  ...
                  <a
                    href="#"
                    onClick={(e) => { e.preventDefault(); setShowForgotPassword(true); setError(''); }}
                    style={{
                      fontSize: '0.875rem', color: 'var(--primary)',
                      textDecoration: 'none', fontWeight: 500, transition: 'opacity 0.2s ease',
                    }}
              ...
              {error && (
                <div style={{
                  ...
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, marginTop: 2 }}>
                ...
                <div style={{
                  ...
                  {resetMessage && (
                    <div style={{
                      ...
                      color: '#166534', borderRadius: '8px', marginBottom: '16px', fontSize: '0.9rem',
                    }}>
                      {resetMessage}
                    </div>
                  )}
                  ...
                  <form onSubmit={handleForgotPassword}>
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                      <button
                        type="button"
                        onClick={() => { setShowForgotPassword(false); setError(''); setResetMessage(''); setResetEmail(''); }}
